 ...
 */
//static char *font = "Inconsolata Medium:pixelsize=20:antialias=true:autohint=true";
static char *font = "JetBrainsMono:pixelsize=20:antialias=true:autohint=true";
//static char *font = "Inconsolata-g:style=g:pixelsize=20:antialias=true:autohint=true";
...
static char *font3[]  = { "SauceCodePro Nerd Font:style=Semibold:size=12:antialias=true:autohint=true"};
